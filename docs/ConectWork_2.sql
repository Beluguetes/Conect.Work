...
idCadastro INT auto_increment primary key not null,
contratante_IdContratante INT  auto_increment primary key  not null,
prestador_IdPrestador INT  auto_increment primary key not null
);
...
logradouroCont VARCHAR (100) not null,
...
logradouroPrest VARCHAR (100) not null,
...
senhaBanco VARCHAR (60) not null
);
