		...
		<div class="conteudo_tela">
			<form class="login">
				<div class="campo_login">
					...
					<input type="text" class="login__entrar" placeholder="Nome">
				</div>
                <div class="campo_login">
					<i class="login__icone"></i>
				...
				<div class="campo_login">
					<i class="login__icone"></i>
					<input type="text" class="login__entrar" placeholder="Escolaridade">
				</div>
				<div class="campo_login">
					<i class="login__icone"></i>
					<input type="text" class="login__entrar" placeholder="Area">
				</div>

				<div class="campo_login">
					<i class="login__icone"></i>
					<input type="text" class="login__entrar" placeholder="CPF">
				</div>
				...
				<a href="<?=linkrota('')?>"class="button login__enviar2">
